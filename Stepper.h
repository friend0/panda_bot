...
#define ShutDownDrive0() TRIS_STEPPER_BOARD0_ENABLE = 0; STEPPER_BOARD0_ENABLE = 1
#define ShutDownDrive1() TRIS_STEPPER_BOARD1_ENABLE = 0; STEPPER_BOARD1_ENABLE = 1
#define ShutDownDrives() TRIS_STEPPER_BOARD0_ENABLE = 0; TRIS_STEPPER_BOARD1_ENABLE = 0; \
                         STEPPER_BOARD0_ENABLE = 1; STEPPER_BOARD1_ENABLE = 1

#define TurnOnDrive0() TRIS_STEPPER_BOARD0_ENABLE = 0; STEPPER_BOARD0_ENABLE = 0
#define TurnOnDrive1() TRIS_STEPPER_BOARD1_ENABLE = 0; STEPPER_BOARD1_ENABLE = 0
#define TurnOnDrives() TRIS_STEPPER_BOARD0_ENABLE = 0; TRIS_STEPPER_BOARD1_ENABLE = 0; \
                       STEPPER_BOARD0_ENABLE = 0; STEPPER_BOARD1_ENABLE = 0
