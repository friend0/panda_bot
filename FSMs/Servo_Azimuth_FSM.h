/*
 * File: ServoAzimuthFSM.h
 * Author: J. Edward Carryer
 * Modified: Gabriel H Elkaim
 *
 * ServoAzimuth file to set up a Flat State Machine to work with the Events and Services
...
#ifndef Servo_Azimuth_FSM_H  // <- This should be changed to your own guard on both
#define Servo_Azimuth_FSM_H  //    of these lines
...
typedef enum {
    InitSState, holdingAzimuth, azimuthBuffer, movingAzimuth, movingAzimuthPreset
} Servo_Azimuth_State_t;  // <- Change this name along with your state names
...
/**
 * @Function InitServoAzimuthFSM(uint8_t Priority)
 * @param Priority - internal variable to track which event queue to use
 * @return TRUE or FALSE
 * @brief This will get called by the framework at the beginning of the code
 *        execution. It will post an ES_INIT event to the appropriate event
 *        queue, which will be handled inside RunServoAzimuthFSM function. Remember
...
/**
 * @Function PostServoAzimuthFSM(ES_Event ThisEvent)
...
/**
 * @Function QueryServoAzimuthFSM(void)
 * @param none
 ...
 *        something appropriate, and also to rename the Servo_Azimuth_State_t to your
 *        correct variable name.
 * @author J. Edward Carryer, 2011.10.23 19:25 */
Servo_Azimuth_State_t QueryServoAzimuthFSM(void);

/**
 * @Function RunServoAzimuthFSM(ES_Event ThisEvent)
